...
# import from shared module so torch.save serializes as
# mirai.core.models_heads.TransformerWithNHeads (always findable)
from models_head import FixedMLP, HeadProjection, TransformerWithNHeads
